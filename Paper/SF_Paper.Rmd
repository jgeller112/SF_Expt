...
The three experiments herein present evidence against claims put forth by its creators and the media [also see @Eskenazi2020) that Sans Forgetica font can boost memory.  We reccomend caution in using Sans Forgetica font. Students looking to remember more and forget less should use other "power tools"  shown to enhance learning. It is our conclusion that Sans Forgetica lives up to its name and is forgetible. 
