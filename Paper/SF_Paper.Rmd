...
```{r, echo=FALSE, fig.height=4,fig.cap=paste("Accuracy on Cued Recall Test. Error bars are 95% HDI dervied from the brms model.")}
...
```{r, fig.cap=paste("Passage accuracy. Error bars are 95% HDI dervied from the brms model")}
