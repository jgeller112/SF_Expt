...
\begin{figure}
\includegraphics[width=5.87in]{/Users/gellr/SF_Expt2/sf} \caption{Example of Sans Forgetica font. }\label{fig:unnamed-chunk-1}
\end{figure}
...
\includegraphics[width=8in]{/Users/gellr/SF_Expt2/brms_dis_plot} \textbackslash{}caption\{Accuracy on Cued Recall Test. Error bars are 95\% HDI dervied from the brms model.\}\label{fig:unnamed-chunk-3}
...
\textbackslash{}begin\{figure\}
\includegraphics[width=8in]{/Users/gellr/SF_Expt2/brms_passage} \textbackslash{}caption\{Passage accuracy. Error bars are 95\% HDI dervied from the brms model\}\label{fig:unnamed-chunk-5}
\textbackslash{}end\{figure\}
...
{\centering \includegraphics{SF_Paper_files/figure-latex/unnamed-chunk-6-1} 
