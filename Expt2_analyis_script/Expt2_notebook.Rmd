...
ground <- qualtRics::read_survey(here::here("Expt2_data", "qualtrics_raw", "memory_for_words_final.csv")) # raw data
...
question<-read_csv(here::here("Expt2_data", "questions",  "question_response.csv")) # read in correct responses 
